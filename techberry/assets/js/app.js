...
var _animlogo = _interopRequireDefault(require("./modules/animlogo"));

var _accordion = _interopRequireDefault(require("./modules/accordion"));

var _index = _interopRequireDefault(require("./modules/open-menu/index"));

var _ocean = _interopRequireDefault(require("./modules/ocean"));
...
// import animBtn from './modules/animation-btn/index';
// import animTitle from './modules/animation-title/index';
(function ($) {
  // When DOM is ready
  $(function () {
    // burgerMenu.init();
    ...
    _animlogo["default"].init();

    _accordion["default"].init(); // animBtn.init();


    _index["default"].init(); // animTitle.init();
    ...
    wow.init();
    $('select').niceSelect(); // setTimeout($('.popups').niceScroll(), 1000);
...
},{"./modules/accordion":3,"./modules/animlogo":4,"./modules/ocean":5,"./modules/open-menu/index":6,"./modules/popup":7,"./modules/slider":8}],3:[function(require,module,exports){
"use strict";
...
var animLogos = function () {
  var animLogosInit = function animLogosInit() {
    var animateMarquee = function animateMarquee(el, duration) {
      var innerEl = el.querySelector('.logos__row-wrapper');
    ...
    var marquee3 = document.querySelector('#marquee3');
    animateMarquee(marquee1, 80000);
    animateMarquee(marquee2, 40000);
    animateMarquee(marquee3, 60000);
  };

  var init = function init() {
    var LOGOS = document.querySelectorAll('.logo-list.logos');
...
var ocean = function () {
  if ((typeof THREE === "undefined" ? "undefined" : _typeof(THREE)) !== 'object' || !WEBGL) {
    return {
      init: function init() {}
    };
  }
  ...
  function initAnimation() {
    var container = document.querySelector('#ocean-bg');
    camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 1, 10000);
    camera.position.z = 1000;
    scene = new THREE.Scene(); // Background color //
  ...
  function render() {
    ...
    renderer.render(scene, camera); // Speed //
...
var openMenuFunc = function () {
  var menuFunc = function menuFunc() {
    ...
    var menuItems = menuWrap.querySelectorAll('.menu__item');
    var openMenuCtrl = document.querySelector('.button-menu');
    var closeMenuCtrl = menuWrap.querySelector('.button-close');
...
var NEXT_STEP = document.querySelector('.next-step');
var PREV_STEP = document.querySelector('.prev-step');
var ONE_STEP = document.querySelector('#step-one');
var TWO_STEP = document.querySelector('#step-two');
...
var popup = function () {
  var nextStep = function nextStep() {
    NEXT_STEP.addEventListener('click', function () {
      ONE_STEP.classList.remove(CLASS_ACTIVE);
      TWO_STEP.classList.add(CLASS_ACTIVE);
    });
  };

  var prevStep = function prevStep() {
    PREV_STEP.addEventListener('click', function () {
      ONE_STEP.classList.add(CLASS_ACTIVE);
      TWO_STEP.classList.remove(CLASS_ACTIVE);
    });
  };
  ...
  var showPopupInit = function showPopupInit() {
    if (POPUP_SHOW !== null) {
      for (var i = 0; i < POPUP_SHOW.length; i += 1) {
        ...
        POPUP_SHOW[i].addEventListener('click', function (event) {
          event.preventDefault(); // eslint-disable-next-line no-shadow

          for (var _i = 0; _i < POPUPS.length; _i += 1) {
            if (POPUPS[_i].classList.contains('active')) {
              POPUPS[_i].classList.remove(CLASS_ACTIVE);
            }
          }
    ...
    if (CLOSE_BTN !== null) {
      for (var _i2 = 0; _i2 < CLOSE_BTN.length; _i2 += 1) {
        CLOSE_BTN[_i2].addEventListener('click', function (event) {
          event.preventDefault();
          hidePopup();
        });
      }
...
var swiperSlider = function () {
  var cardsTarif = new Swiper('.js-cards-slider', {
    enabled: true,
    slidesPerView: 1,
    spaceBetween: 18,
    navigation: {
